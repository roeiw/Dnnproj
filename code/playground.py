...
train_dataset = SIDD_Dataset.SIDD('../data/patches/medium/image_csv.csv','./data/patches/medium/image_csv.csv', transform)
...
t = Trainer(args, test_dataloders,train_dataloders, model, loss, utility.checkpoint(args), model_path+'27621_l2.pt')
t.train()
